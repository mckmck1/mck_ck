...
using mkc.demo2.work127.Model;
using mkc.demo2.work127.Rbac;
...
namespace mkc.demo2.work127.EntityFrameworkCore
{
    ...
    public class work127DbContext : 
        AbpDbContext<work127DbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        public work127DbContext(DbContextOptions<work127DbContext> options)
            : base(options)
        {
